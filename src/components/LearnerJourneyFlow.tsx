...
export default function LearnerJourneyFlow() {
  const journeyStages = [
    {
      id: "journey-stage-1",
      title: "Visibility",
      description: "Pathways may exist on paper, but they are not always visible, relatable or easy to interpret early enough.",
      svgComponent: <StageBabySvg className="w-20 h-36 text-[#2BB7BA] mx-auto group-hover:text-[#FF9900] transition-colors duration-300" />,
    ...
    },
    {
      ...
      description: "Parents, carers and trusted adults influence choices, but routes into local jobs and future sectors are not always clear, current or easy to explain.",
      svgComponent: <StageToddlerSvg className="w-20 h-36 text-[#FF9900] mx-auto group-hover:text-[#3AB03A] transition-colors duration-300" />,
    ...
    },
    {
      id: "journey-stage-3",
      title: "Transitions",
      description: "School-to-post-16 and post-16-to-work handoffs can feel cold, late or unclear.",
      svgComponent: <StageSchoolchildSvg className="w-20 h-36 text-[#3AB03A] mx-auto group-hover:text-[#2BB7BA] transition-colors duration-300" />,
    ...
    },
    {
      ...
      svgComponent: <StageYoungAdultSvg className="w-20 h-36 text-[#986430] mx-auto group-hover:text-[#2E536B] transition-colors duration-300" />,
    ...
    },
    {
      ...
      svgComponent: <StageAdultSvg className="w-20 h-36 text-[#969696] mx-auto group-hover:text-[#2BB7BA] transition-colors duration-300" />,
    ...
    },
    {
      ...
      svgComponent: <StageProfessionalSvg className="w-20 h-36 text-[#2E536B] mx-auto group-hover:text-[#FF9900] transition-colors duration-300" />,
  ...
  return (
    <div className="w-full space-y-12" id="learner-transition-flow-section">
      ...
      <div className="space-y-4 text-left max-w-4xl">
        ...
        <h2 className="text-3xl font-normal text-[#2E536B] tracking-tight">
          Six Strategic Gaps Across the Learner Journey
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-2">
        <div className="bg-white border-l-4 border-l-[#2BB7BA] border-y border-r border-[#969696]/15 hover:border-[#2BB7BA]/50 p-6 rounded shadow-xs hover:shadow-sm transition-all duration-300">
          <p className="text-4xl sm:text-[42px] font-light text-[#2BB7BA] tracking-tight leading-none font-sans">
            40+
          </p>
          <p className="text-xs text-[#51615a] leading-relaxed mt-2.5 font-sans">
            organisations engaged
          </p>
        </div>

        <div className="bg-white border-l-4 border-l-[#3AB03A] border-y border-r border-[#969696]/15 hover:border-[#3AB03A]/50 p-6 rounded shadow-xs hover:shadow-sm transition-all duration-300">
          <p className="text-4xl sm:text-[42px] font-light text-[#3AB03A] tracking-tight leading-none font-sans">
            171
          </p>
          <p className="text-xs text-[#51615a] leading-relaxed mt-2.5 font-sans">
        ...
        <div className="bg-white border-l-4 border-l-[#2E536B] border-y border-r border-[#969696]/15 hover:border-[#2E536B]/50 p-6 rounded shadow-xs hover:shadow-sm transition-all duration-300">
          <p className="text-4xl sm:text-[42px] font-light text-[#2E536B] tracking-tight leading-none font-sans">
            6
          </p>
          <p className="text-xs text-[#51615a] leading-relaxed mt-2.5 font-sans">
          ...
          >
            ...
            <div className="space-y-3 flex-1 flex flex-col justify-start text-left pt-1">
              <div className="md:h-16 flex items-start">
                <h4 className={`text-xs font-bold tracking-wider text-slate-800 uppercase leading-snug ${stage.hoverTitle} transition-colors duration-200`}>
                  {stage.title}
                </h4>
              </div>
              <p className="text-xs text-[#51615a] leading-relaxed border-t border-gray-100 pt-3 font-sans">
                {stage.description}
              </p>
            </div>
          </div>
